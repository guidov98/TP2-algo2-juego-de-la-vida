...
int Tablero::imprimirTablero(){
	...
	int color1 = (this->getCeldaPos(0,2,3)->getCelula()->getCargaGeneticaGen1());
	int color2 = (this->getCeldaPos(0,2,3)->getCelula()->getCargaGeneticaGen2());
	int color3 = (this->getCeldaPos(0,2,3)->getCelula()->getCargaGeneticaGen3());
	std::cout << "\x1b[38;2;"<<color1<<";"<<color2<<";"<<color3<<"m█\x1b[0m";
	std::cout << "\x1b[38;2;"<<color1<<";"<<color2<<";"<<color3<<"m█\x1b[0m";
	std::cout << this->getCeldaPos(0,2,3)->contarVecinos() << std::endl;
	return 0;
}
