...
class Gen {
	...
	public:
		 ...
		 */
		Gen(unsigned int maximoCargaGentica);
		 ...
		 */
		Gen(unsigned int maximoCargaGentica, unsigned int cargaGenticaTotal);

		/**
		 * pre: El Gen debe estar inicializada
		 * pos: Elimina el Gen
		 */
		virtual ~Gen();
		 ...
		 */
		void setCargaGentica(unsigned int maximoCargaGentica);

		/**
		 * pre: la cargaGentica debe ser un valor entre 0 y maximoDeCargaGentica inclusive
		 * pos: cambia el valor de cargaGentica
		 */
		void setMaximoDeCargaGentica(unsigned int cargaGenticaTotal);
